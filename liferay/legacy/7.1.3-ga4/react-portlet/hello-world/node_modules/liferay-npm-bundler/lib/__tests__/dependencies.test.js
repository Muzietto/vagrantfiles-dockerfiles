  ...
  toMatchDependencies: function toMatchDependencies(deps) {
    ...
    pkgIds.forEach(function (pkgId) {
      ...
      if (!dep) {
        ...
        var pkgName = pkgIdParts[0];
        var pkgVersion = pkgIdParts[1];
        ...
        var expectedDepDir = _path2.default.normalize('/node_modules/' + pkgName);
...
it.only('loads project dependencies correctly', function () {
  var deps = (0, _dependencies.getPackageDependencies)('.');

  expect(deps).toMatchDependencies('test-project@1.0.0', 'test-project-dep-0@1.0.0', 'test-project-dep-1@1.0.0', 'test-project-dep-0@0.1.0');
});
